...
public class MyComponentConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(MyComponentConsumer.class);

    private final MyComponentEndpoint endpoint;


    public MyComponentConsumer(final MyComponentEndpoint endpoint, final Processor processor) {
